...
func WriteProtobufToBinaryFile(message proto.Message, filename string) error {
	...
	if err != nil {
		return fmt.Errorf("cannot marshal proto message to binary file: %v", err)
	}
...
// WriteProtobufToJSONFile writes protobuf message to a JSON file
func WriteProtobufToJSONFile(message proto.Message, filename string) error {
	...
	if err != nil {
		return fmt.Errorf("cannot write JSON data into file:%w", err)
	}
	return nil
}
