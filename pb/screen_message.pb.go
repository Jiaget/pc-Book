...
type Screen struct {
	...
	SizeCentimeter float32            `protobuf:"fixed32,1,opt,name=size_centimeter,json=sizeCentimeter,proto3" json:"size_centimeter,omitempty"`
	Resolution     *Screen_Resolution `protobuf:"bytes,2,opt,name=resolution,proto3" json:"resolution,omitempty"`
	Panel          Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=jiaget.pcbook.Screen_Panel" json:"panel,omitempty"`
...
func (x *Screen) GetSizeCentimeter() float32 {
	if x != nil {
		return x.SizeCentimeter
	}
	return 0
}
...
var file_screen_message_proto_rawDesc = []byte{
	...
	,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: jiaget.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: jiaget.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: jiaget.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: jiaget.pcbook.Screen.resolution:type_name -> jiaget.pcbook.Screen.Resolution
	0, // 1: jiaget.pcbook.Screen.panel:type_name -> jiaget.pcbook.Screen.Panel
