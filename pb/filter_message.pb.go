...
type Filter struct {
	...
	MaxPriceRmb float64 `protobuf:"fixed64,1,opt,name=max_price_rmb,json=maxPriceRmb,proto3" json:"max_price_rmb,omitempty"`
	...
	MinRam      float64 `protobuf:"fixed64,4,opt,name=min_ram,json=minRam,proto3" json:"min_ram,omitempty"`
}
...
func (x *Filter) GetMaxPriceRmb() float64 {
	if x != nil {
		return x.MaxPriceRmb
	}
	return 0
}
...
func (x *Filter) GetMinRam() float64 {
	if x != nil {
		return x.MinRam
	}
	return 0
...
var file_filter_message_proto_rawDesc = []byte{
	...
	0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0x89, 0x01, 0x0a, 0x06, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72,
	0x12, 0x22, 0x0a, 0x0d, 0x6d, 0x61, 0x78, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x5f, 0x72, 0x6d,
	0x62, 0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0b, 0x6d, 0x61, 0x78, 0x50, 0x72, 0x69, 0x63,
	0x65, 0x52, 0x6d, 0x62, 0x12, 0x22, 0x0a, 0x0d, 0x6d, 0x69, 0x6e, 0x5f, 0x63, 0x70, 0x75, 0x5f,
	...
	0x69, 0x6e, 0x43, 0x70, 0x75, 0x47, 0x68, 0x7a, 0x12, 0x17, 0x0a, 0x07, 0x6d, 0x69, 0x6e, 0x5f,
	0x72, 0x61, 0x6d, 0x18, 0x04, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x6d, 0x69, 0x6e, 0x52, 0x61,
	0x6d, 0x42, 0x26, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x6a, 0x69, 0x61, 0x67, 0x65, 0x74, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x70, 0x62,
...
var file_filter_message_proto_goTypes = []interface{}{
	(*Filter)(nil), // 0: jiaget.pcbook.Filter
}
