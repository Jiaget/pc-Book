...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x6a, 0x69, 0x61, 0x67, 0x65,
	...
	0x32, 0x15, 0x2e, 0x6a, 0x69, 0x61, 0x67, 0x65, 0x74, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: jiaget.pcbook.CPU
	(*GPU)(nil),    // 1: jiaget.pcbook.GPU
	(*Memory)(nil), // 2: jiaget.pcbook.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: jiaget.pcbook.GPU.memory:type_name -> jiaget.pcbook.Memory
