...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x2e, 0x6a, 0x69, 0x61, 0x67, 0x65, 0x74, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x23, 0x2e, 0x6a, 0x69, 0x61, 0x67, 0x65, 0x74, 0x2e, 0x70, 0x63, 0x62, 0x6f,
	...
	0x72, 0x63, 0x68, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x12, 0x22, 0x2e, 0x6a, 0x69, 0x61, 0x67,
	0x65, 0x74, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68,
	...
	0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x26, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x6a, 0x69, 0x61, 0x67, 0x65, 0x74, 0x2e, 0x70, 0x63, 0x62, 0x6f,
...
var file_laptop_service_proto_goTypes = []interface{}{
	...
	(*Laptop)(nil),               // 4: jiaget.pcbook.Laptop
	(*Filter)(nil),               // 5: jiaget.pcbook.Filter
}
var file_laptop_service_proto_depIdxs = []int32{
	4, // 0: jiaget.pcbook.CreateLaptopRequest.laptop:type_name -> jiaget.pcbook.Laptop
	5, // 1: jiaget.pcbook.SearchLaptopRequest.filter:type_name -> jiaget.pcbook.Filter
	4, // 2: jiaget.pcbook.SearchLaptopResponse.laptop:type_name -> jiaget.pcbook.Laptop
	0, // 3: jiaget.pcbook.LaptopService.CreateLaptop:input_type -> jiaget.pcbook.CreateLaptopRequest
	2, // 4: jiaget.pcbook.LaptopService.SearchLaptop:input_type -> jiaget.pcbook.SearchLaptopRequest
	1, // 5: jiaget.pcbook.LaptopService.CreateLaptop:output_type -> jiaget.pcbook.CreateLaptopResponse
	3, // 6: jiaget.pcbook.LaptopService.SearchLaptop:output_type -> jiaget.pcbook.SearchLaptopResponse
